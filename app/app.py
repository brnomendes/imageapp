...
class ImageApp:
    ...
    def start(self):
        ...
        """
        parser = argparse.ArgumentParser(description="An app to process images.")
        ...
        for flag in register.filters:
            ...
            group.add_argument(
                f"--{flag}", metavar=tuple(filter_args), nargs=len(filter_args), help=register.filters[flag].help
            )
